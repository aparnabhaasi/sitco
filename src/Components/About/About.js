    ...
    <>
      ...
      <div className="who-we mt-3">
        ...
        <div className="container t ">
          <p className="mb-5">At Sitco, we take immense pride in being a premier construction company in Kerala, focusing exclusively on government projects. Established with a vision to contribute to the state's growth and development, we bring a wealth of expertise and experience to every project we embark upon.</p>
        </div>
      </div>
        ...
        <div class="row w-100">
          <div class="col-12 col-sm-6 col-md-4 col-lg-4">
            <div class="card shadow ">
              <div className=""><img src="https://i.postimg.cc/k5J9D6qF/Mission-a.png" alt="" class="card-img-top" /></div>
              <div class="card-body">
                <h3 class="text-center">Our Mission</h3>
                <hr class="mx-auto w-75" />
                <p>
                  Our mission is to set new industry standards by executing government projects that support Kerala's growth and improve the lives of its people. Through expertise, dedication, and innovation, we aim to redefine infrastructure in Kerala.
                </p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-4">
            <div class="card shadow">
              <img src="https://i.postimg.cc/263DFsq1/vison-a.png" alt="" class="card-img-top" />
              <div class="card-body">
                <h3 class="text-center">Our Vision</h3>
                <hr class="mx-auto w-75" />
                <p>
                  Our vision is to lead Kerala's infrastructure development, crafting sustainable government projects that showcase our commitment to excellence. We aim to create a modern, resilient infrastructure that empowers communities and drives progress by collaborating with government bodies, stakeholders, and experts.
                </p>
              </div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-4">
            <div class="card shadow">
              <img src="https://i.postimg.cc/MG9wB6Gk/values-a.png" alt="" class="card-img-top" />
              <div class="card-body">
                <h3 class="text-center">Our values</h3>
                <hr class="mx-auto w-75" />
                <p>
                  Integrity: We uphold the highest ethical standards, building trust and transparency in all our interactions.
                  Quality: We are dedicated to delivering enduring, high-quality projects.
                  Innovation: We embrace innovation and cutting-edge technology to achieve efficiency and superior outcomes.
                  Collaboration: We foster partnerships with government bodies, stakeholders, and communities for holistic project success.
                </p>
              </div>
            </div>
          </div>
      ...
      <div>
        ...
        <div className="container t ">
          <p className="mb-5">With years of hands-on experience in the construction industry, our team at Sitco possesses an unparalleled understanding of the unique challenges and requirements of government projects. Our proficiency spans across various domains, including civil engineering, architecture, project management, and more.</p>
        </div>
      </div>
          ...
          <div class="gradient-cards">
            ...
            <div class="card">
              <div class="container-card bg-yellow-box">
                <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="">
      ...
      <div className="container">
        ...
        <div className="mt-3 brd ">
          <div className='heading'>
            <h1>Get in touch with us</h1>
            <div className='line'></div>
          </div>
          <div className="container  p-4">
            <p className="getin p-5">Are you ready to partner with a construction company that is dedicated to building not just structures, but a better tomorrow? Contact us today to discuss your government project needs or to learn more about our services.</p>
          </div>
          <div className="container mb-4">
            <Link to='/contact'><Button variant="outline-success"><strong>Contact Us</strong></Button></Link>
          </div>
        </div>
      </div>
